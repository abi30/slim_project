...
$url = "https://auth.dionera.com/oauth2/auth?client_id=$client_id&client_secret=$client_secret&state=$state&redirect_uri=$redirect_uri&scope=$scope&response_type=code";
